...
@Database(entities = [Movie::class, Company::class, Country::class, Genre::class, Language::class, aws.com.themoviedb.app.db.pojo.Collection::class], version = 3, exportSchema = false)
